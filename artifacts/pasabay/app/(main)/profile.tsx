    ...
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: topPad }]}>
      ...
      >
        ...
        <Section title="Account" colors={colors}>
          <MenuItem icon="user" label="Edit profile" colors={colors} onPress={() => {}} />
          <MenuItem icon="credit-card" label="Payment methods" colors={colors} onPress={() => {}} />
        ...
        <Section title="Safety" colors={colors}>
          <MenuItem icon="phone" label="Emergency contact" colors={colors} onPress={() => {}} />
        </Section>

        <Section title="App" colors={colors}>
          <MenuItem icon="settings" label="Settings" colors={colors} onPress={() => {}} />
          <MenuItem icon="help-circle" label="Help & Support" colors={colors} onPress={() => {}} />
          <MenuItem icon="info" label="About Pasabay" colors={colors} onPress={() => {}} />
        </Section>
